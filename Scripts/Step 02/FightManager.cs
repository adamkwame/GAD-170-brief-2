...
public class FightManager : MonoBehaviour
{
    ...
    private void DecideWinner(Character teamACharacter, Character teamBCharacter)
    {
        ...
        {
            teamBCharacter.myStatsSystem.ChangeHealth(-1);
            teamACharacter.myLevelSystem.AddXP(1);
        ...
        {
            teamACharacter.myStatsSystem.ChangeHealth(-1);
            teamBCharacter.myLevelSystem.AddXP(1);
