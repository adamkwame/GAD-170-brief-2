...
public class BattleSystem : MonoBehaviour
{
    ...
    {     
        ...
        else
        {
            ...
            if ( teamA.activeDancers[0].myPowerSystem.myStats.playerHealth > teamB.activeDancers[0].myPowerSystem.myStats.playerHealth)
            {
                  winner = teamA.activeDancers[0].myTeam;
            }
